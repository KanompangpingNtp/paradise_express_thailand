  ...
  return (
    <div className="container mx-auto px-2 sm:px-8 pb-10">
      ...
      <div className="flex justify-center w-full text-center sm:justify-end items-center text-black mt-4">
        <Link href={`/pages/allTour/TourSightseeing`} passHref className="bg-gray-700 text-white py-3 px-5 w-full 2xl:w-40 hover:text-orange-500 hover:bg-gray-900 duration-200 rounded-2xl cursor-pointer">
            VIEW ALL
        </Link>
      </div>
    </div>
