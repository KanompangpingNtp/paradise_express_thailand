...
export default function TourForm({ onSubmit, section }) {
  const [formData, setFormData] = useState({
    tour_section_name: section,
    tour_name: "",
    tour_detail: "",
  ...
  const validateForm = () => {
    ...
    if (!formData.tour_name)
      newErrors.tour_name = "Please specify the tour name.";
  ...
  return (
    <div className="w-full">
      <h2 className="text-2xl text-sky-600 font-bold flex items-center justify-center">
